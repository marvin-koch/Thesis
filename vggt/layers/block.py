...
class NestedTensorBlock(Block):
    def forward_nested(self, x_list: List[Tensor], attn_mask: Tensor | None = None) -> List[Tensor]:
        """
        ...
        if self.training and self.sample_drop_ratio > 0.0:
            ...
            def attn_residual_func(x: Tensor, attn_bias=None) -> Tensor:
                return self.attn(self.norm1(x), attn_bias=attn_bias, attn_mask=attn_mask)
